---
description: "changelog.dart HACKING guide"
---
...
- Generate the changelog related to the package:
    ...
    - `make {changelog_lib|changelog_cmd|changelog}`, where`make {changelog_client|changelog_flutter|changelog}`, where
...
N.B: Part of this document is stolen from [core lightning](https://github.com/ElementsProject/lightning/blob/master/doc/HACKING.md) from @rustyrussell 's experience.
